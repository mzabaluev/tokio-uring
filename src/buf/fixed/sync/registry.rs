...
/// A thread-safe, indexed collection of I/O buffers pre-registered with the kernel.
///
...
///
/// Unlike [`FixedBufRegistry`][non-threadsafe] in the parent module, this
...
///
/// [non-threadsafe]: crate::buf::fixed::FixedBufRegistry
...
impl FixedBufRegistry {
    ...
    ///
    /// ```should_panic
    /// use tokio_uring::buf::fixed::sync::FixedBufRegistry;
    /// use std::iter;
    ///
    ...
    pub fn new(bufs: impl IntoIterator<Item = Vec<u8>>) -> Self {
        FixedBufRegistry {
            inner: Arc::new(Mutex::new(plumbing::Registry::new(bufs.into_iter()))),
        }
    }
